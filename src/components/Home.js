                ...
                <div className="modalim">
                    <div className='modalim2'>
                        ...
                        <div className="flex2">
                            ...
                            <hr />
                            <h4>{show.narxi}</h4>
                            <p>Lorem ipsum dolor sit amet consectetur aing elit. Iste excepturi illum assumenda magnam provident voluptatum earum, incidunt fugit quibusdam mollitia? Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat, recusandae!</p><button className='close' onClick={Close}>X</button>
